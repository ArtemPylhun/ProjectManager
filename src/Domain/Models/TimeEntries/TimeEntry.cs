...
public class TimeEntry
{
    ...
    private TimeEntry(TimeEntryId id, string description, DateTime startDate, DateTime endDate, int minutes,
    ...
    public void UpdateDetails(string description, DateTime startTime, DateTime endTime, int minutes, Guid userId,
