    ...
    public static ObjectResult ToObjectResult(this UserException exception)
    {
        return new ObjectResult(exception.Message)
        {
            StatusCode = exception switch
            {
                ...
                UserWithNameAlreadyExistsException or UserWithEmailAlreadyExistsException or UserAlreadyUsedInProject
                    or EmailVerificationTokenExpiredException or InvalidVerificationTokenException
                    or EmailNotVerifiedException => StatusCodes
                        .Status409Conflict,
